...
/// <summary>
/// Strongly-typed identifier for a field in the internal model.
/// 
/// Avoids using raw strings across the system and centralizes validation rules
/// (IKOVS_ prefix, allowed characters, optional role suffix).
/// </summary>
namespace Assistant.Core.Model.Aliases
{
