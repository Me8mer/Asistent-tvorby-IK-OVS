...
namespace Assistant.Dependencies.Context.Web.Storage
{
    public sealed class WebContextPack
    {
        ...
        private readonly IReadOnlyList<WebContextSnippet> snippets;
            ...
            IReadOnlyList<WebContextSnippet> snippets)
        {
            ...
            this.snippets = snippets ?? Array.Empty<WebContextSnippet>();
        }
        ...
        public (string Text, IReadOnlyList<string> References) GetContextText(string intent)
        {
            ...
            string text = string.Join(
                "\n\n",
                matching.Select(s => s.Text).Where(t => !string.IsNullOrWhiteSpace(t)));
        ...
        public bool HasAnySnippetsForIntent(string intent)
        {
            ...
            return snippets.Any(s => string.Equals(s.Intent, intent, StringComparison.OrdinalIgnoreCase));
        }
    }
}